...
public:
    ...
    void ProcessSubScript(const CScript& subscript, UniValue& obj, bool include_addresses = false) const
    {
        ...
        // addresses to refer to multisig keys that should not be treated like destinations. For that
        // reason, only add the 'addresses' field when needed for backward compatibility. New applications

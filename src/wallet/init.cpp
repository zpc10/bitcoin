...
std::string GetWalletHelpString(bool showDebug)
{
    ...
    strUsage += HelpMessageOpt("-addresstype", strprintf(_("What type of addresses to use (\"legacy\", \"p2sh\", \"bech32\", default: \"%s\")"), FormatOutputType(OutputType::DEFAULT)));
    strUsage += HelpMessageOpt("-changetype", strprintf(_("What type of change to use (\"legacy\", \"p2sh\", \"bech32\", default is same as -addresstype: \"%s\")"), FormatOutputType(OutputType::DEFAULT)));
...
bool WalletParameterInteraction()
{
    ...
    if (g_address_type == OutputType::NONE) {
